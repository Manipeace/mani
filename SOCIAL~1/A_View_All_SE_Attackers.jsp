...
<head>
<title>A_View_All_SE_Attackers</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
        <h1 class="style4"><a href="#" class="style7">Social Engineering Attacks Prevention A Systematic Literature Review</a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33 style33 style43">View All Social Engineers PRETEXTING Attackers !!! </span></h2>
          <br>
          <div class="clr"></div>
...
<td  width="47" height="45"  valign="middle" bgcolor="#FFFF00" ><div align="center" class="style1 style12 style11 style14 style59">
  <strong>RIID</strong></strong></div></td>
<td  width="47" height="45"  valign="middle" bgcolor="#FFFF00" ><div align="center" class="style1 style12 style11 style14 style59">
  <strong>Description </strong></strong>(pretexting)</div></td>
<td  width="47" height="45"  valign="middle" bgcolor="#FFFF00" ><div align="center" class="style1 style12 style11 style14 style59">
  ...
  <strong>Attacked URL</strong></strong></div></td>
            ...
            <%
					  ...
					  String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11;
						...
						try 
						{
						   	String query="select * from social_engineering_attack"; 
            ...
            <p align="center"><a href="ServerMain.jsp" class="style20 style45"><strong>Back</strong></a></p>
