...
<head>
<title>S_View_SEAttacker_Results</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34"><span class="style12">View SE Pretexting Attacker Results.. </span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
            <div>
			 ...
			 <iframe width="700" height="510" src="Results1.jsp"></iframe>
