...
.style38 {color: #006600; font-weight: bold; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34">Welcome to Server Login </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
            <form id="form1" name="form1" method="post" action="ServerAuthentication.jsp">
              <table width="464" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="197" height="46" align="center"><span class="style38">
                    <label for="name">Name (required)</label>
                  </span> </td>
                  <td width="253"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
                  <td height="40" align="center"><span class="style38">Password (required)</span></td>
